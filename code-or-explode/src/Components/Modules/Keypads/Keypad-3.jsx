...
//if they get the correct answer then we will return the array [1, 2, 3, 4, 1]
//if they get the wrong answer then we will return the array [1, 2, 2, 4, 1]
import React, {useState} from 'react'
import styled from 'styled-components'

export default function KeyPad(props) {
  const { strikeAdd, positionId, moduleComplete } = props
    const [rightArray] = useState([1, 2, 3, 4])
